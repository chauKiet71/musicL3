...
public class TimKiem_TatCa extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        list_PlayList1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                list_PlayList1MouseReleased(evt);
            }
        });
    ...
    private void list_PlayList1MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_list_PlayList1MouseReleased
        play();
    }//GEN-LAST:event_list_PlayList1MouseReleased
